                    ...
                    >
                        ...
                        <div class="relative z-10 h-full flex flex-col">
                            ...
                            {#if i === pages.length - 1}
                                ...
                                <!-- Footer (Classic Signature) -->
                                <div class="pt-8 mt-4 border-t border-base-200">
                                    <div class="flex justify-between mt-8 px-4">
                                        <div class="text-center">
                                            ...
                                            <p
                                                class="font-bold border-t border-black px-4 inline-block min-w-[150px]"
                                            >
                                                {employee.name}
                                            </p>
                                        </div>
                                    ...
                                    <div
                                        class="text-center text-[10px] opacity-70 mt-8"
                                    >
                                        <p class="font-mono italic">
                                            * Dokumen ini dicetak pada {new Date().toLocaleDateString(
                                                "id-ID",
                                                {
                                                    day: "numeric",
                                                    month: "long",
